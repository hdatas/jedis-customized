...
public class Client extends BinaryClient implements Commands {
  ...
  public void hcdSetCompactRange(final String poolLow, final String pooHigh, final String shardLow, final String shardHigh) {
    hcdSetCompactRange(poolLow.getBytes(), pooHigh.getBytes(), shardLow.getBytes(), shardHigh.getBytes());
  }
